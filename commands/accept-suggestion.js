...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            db.updateSuggestionStatus(messageId, 'accepted');
            ...
            await interaction.reply({ content: 'Suggestion has been accepted!', flags: MessageFlags.Ephemeral });
        } catch (error) {
            console.error('Error accepting suggestion:', error);
            await interaction.reply({ content: 'There was an error accepting the suggestion.', flags: MessageFlags.Ephemeral });
        }
    }
}; 